...
class SevenSalon extends StatefulWidget {


  @override
  State<SevenSalon> createState() => _HomeScreenState();
}


class _HomeScreenState extends State<SevenSalon> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Center(child: const Text('JOHN\'S BARBER SHOP',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30,color: Colors.brown),))),
          ...
          children: [
            ...
            Column(children: [
              ListTile(
                ...
                title: Text('Classic Men\'s Haircut',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400),),
              ...
              ListTile(
                ...
                title: Text('Royal Shave/Royal Beard',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400),),
                ...
                title: Text('Hair Blowdry',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400),),
                ...
                title: Text('Hair Tonic',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400),),
                subtitle: Text('10 min',style: TextStyle(fontSize: 15),),
                trailing: Text('10\$',style: TextStyle(fontSize: 17),),
              ...
              ListTile(
                ...
                title: Text('Beard Trim',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400),),
