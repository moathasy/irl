...
//                    display the caption of the selected photo
            ...
            Column(children: [
              ...
              ListTile(
                ...
                iconColor: Colors.brown.shade800,
                leading: Checkbox(value: p,
                  onChanged: (value) {
                    setState(() {
                      p = value ?? false;
                    });
                  },),
                title: Text('Total body',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400),),
                subtitle: Text('2 Sess  45 min',style: TextStyle(fontSize: 15),),
              ...
              ListTile(
                ...
                iconColor: Colors.brown.shade800,
                leading: Checkbox(value: q,
                  onChanged: (value) {
                    setState(() {
                      q = value ?? false;
                    });
                  },),
                title: Text('Full Body',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400),),
                subtitle: Text('2 Sess  45 min',style: TextStyle(fontSize: 15),),
              ...
              ListTile(
                ...
                iconColor: Colors.brown.shade800,
                leading: Checkbox(value: r,
                  onChanged: (value) {
                    setState(() {
                      r = value ?? false;
                    });
                  },),
                title: Text('Underarm ',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400),),
                subtitle: Text('2 Sess  45 min',style: TextStyle(fontSize: 15),),
                trailing: Text('20\$',style: TextStyle(fontSize: 17),),
